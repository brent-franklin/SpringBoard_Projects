...
// This returns a new set [1,2,3,4];
...
*/
  ...
  // This code returns a new string of "ref" 
  // by removing duplicates and joining the remaining letters.
...
// This code set two seperate key/value pairs
// New map is {[1,2,3] => true, [1,2,3] => false};
 ...
 const vowelCount = string => {
    ...
    for(let letter of string){
        ...
        if(vowels.includes(lowerLetter)){
            newMap.has(lowerLetter) ? 
            newMap.set(lowerLetter, newMap.get(lowerLetter) + 1) :
            newMap.set(lowerLetter, 1);
        }
    }
    return newMap;
 }
