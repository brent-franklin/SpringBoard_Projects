...
def users_show(user_id):
    ...
    messages = (Message
                .query
                .filter((Message.user_id == user_id) | (Message.id.in_(likes)))
...
def profile():
    ...
    if form.validate_on_submit():
        ...
        if user:
            User.update_user_info(user, **updated_user_info)
            do_login(user)
...
@app.route("/users/<int:message_id>/like/add", methods=["POST"])
...
@app.route("/users/<int:message_id>/like/delete", methods=["POST"])
